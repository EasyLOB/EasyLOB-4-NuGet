...
namespace EasyLOB
{
    public static partial class AppHelper
    {
        ...
        public static string AppName { get { return "Northwind API"; } } // !!!
        ...
        public static void Setup(ContainerBuilder containerBuilder)
        {
            ...
            ResourcesHelper.AddResources("Northwind.WebApi.Resources"); // !!! Web API
        ...
        public static IMapper SetupMappers()
        {
            MapperConfiguration config = new MapperConfiguration(cfg => {
                ...
                // Application
                //cfg.AddProfile<NorthwindViewAutoMapper>(); // !!! Web API
            });
        ...
        public static void SetupProfiles()
        {
            ...
            // Application
            //DataHelper.SetupViewProfiles("Northwind.Data", viewAssemblyName); // !!! Web API
