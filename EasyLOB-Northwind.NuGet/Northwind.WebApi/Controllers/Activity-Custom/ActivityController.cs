...
namespace EasyLOB.Activity.Mvc
{
    public partial class ActivityController : BaseMvcControllerSCRUDApplication<EasyLOB.Activity.Data.Activity>
    {
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            {
                result = new List<ActivityViewModel>()
            };
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewModelHelper<ActivityViewModel, EasyLOB.Activity.Data.Activity>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take)); // !?!
