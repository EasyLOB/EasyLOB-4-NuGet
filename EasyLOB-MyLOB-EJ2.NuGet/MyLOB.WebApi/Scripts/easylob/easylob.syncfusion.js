...
function zOnCollectionView(model, profile, dataSourceUrl, query = "null") {
    var gridId = "Grid_" + profile.Name + model.Suffix;
    ...
    toolbarItems.forEach(function (item) {
        var operation = item.id.replace("Grid_" + profile.Name + "_", "");
    ...
    $("#Collection_" + profile.Name + model.Suffix).parent().show();
    ...
    // DataSource
    if (!model.IsMasterDetail) {
        zGridDataSource("Grid_" + profile.Name, dataSourceUrl, query);
    }
