...
{
    public class ZActionResultOperationResult : IHttpActionResult
    {
        #region Properties
        ...
        public ZActionResultOperationResult(HttpRequestMessage request, ZOperationResult operationResult)
        {
            _request = request;
